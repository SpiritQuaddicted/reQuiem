...
int WIPX_Connect (int socket, const struct qsockaddr *addr);
int WIPX_CheckNewConnections (void);
int WIPX_Read (int socket, byte *buf, int len, const struct qsockaddr *addr);
int WIPX_Write (int socket, const byte *buf, int len, const struct qsockaddr *addr);
int WIPX_Broadcast (int socket, const byte *buf, int len);
